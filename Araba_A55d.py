...
from Araba_A55 import *
import sqlite3


uygulama = QApplication(sys.argv)
pencere = QMainWindow()
ui = Ui_arabalarA55_ekran()
ui.setupUi(pencere)
pencere.show()
...
def kayit_listele():
    ui.A55_tw.clear()
    ui.A55_tw.setHorizontalHeaderLabels(("Lot", "Kalite", "Genişlik"))
    ui.A55_tw.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
...
def kayit_sil():
    ...
    if sil_mesaj == QMessageBox.Yes:
        secilen_satir = ui.A55_tw.currentRow()  
        if secilen_satir == -1:
            ui.statusbar.showMessage("Silinecek bir satır seçilmedi!")
            return

       
        silinecek_lot = ui.A55_tw.item(secilen_satir, 0).text()
        ...
        try:
            ...
            islem.execute(sorgu_a55, (silinecek_lot,))
...
ui.listele55_btn.clicked.connect(kayit_listele)
ui.sil55_btn.clicked.connect(kayit_sil)
