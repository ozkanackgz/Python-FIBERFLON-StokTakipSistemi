...
from Araba_A8 import *
import sqlite3


uygulama = QApplication(sys.argv)
pencere = QMainWindow()
ui = Ui_arabalarA8_ekran()
ui.setupUi(pencere)
pencere.show()
...
def kayit_listele():
    ui.A8_tw.clear()
    ui.A8_tw.setHorizontalHeaderLabels(("Lot", "Kalite", "Genişlik"))
    ui.A8_tw.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
...
def kayit_sil():
    ...
    if sil_mesaj == QMessageBox.Yes:
        ...
        silinecek_lot = ui.A8_tw.item(secilen_satir, 0).text()
        ...
        try:
            ...
            islem.execute(sorgu_a8, (silinecek_lot,))
...
ui.listele8_btn.clicked.connect(kayit_listele)
ui.sil8_btn.clicked.connect(kayit_sil)
